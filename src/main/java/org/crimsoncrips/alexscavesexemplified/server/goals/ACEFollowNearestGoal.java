...
public class ACEFollowNearestGoal<T extends LivingEntity> extends Goal {
    ...
    public ACEFollowNearestGoal(PathfinderMob mob, Class<T> targetType, float areaSize, double speedModifier) {
        this(mob, targetType, areaSize, speedModifier, LivingEntity::isAlive);
    }

    public ACEFollowNearestGoal(PathfinderMob mob, Class<T> targetType, float areaSize, double speedModifier, @Nullable Predicate<LivingEntity> followPredicate) {
        this.mob = mob;
