...
public class ACEDamageTypes {
    ...
    public static final ResourceKey<DamageType> SWEET_PUNISHMENT = ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(AlexsCavesExemplified.MODID, "sweet_punish"));
    ...
    public static DamageSource causeSweetPunishDamage(RegistryAccess registryAccess) {
        return new DamageSourceRandomMessages(registryAccess.registry(Registries.DAMAGE_TYPE).get().getHolderOrThrow(SWEET_PUNISHMENT), 1);
    }
