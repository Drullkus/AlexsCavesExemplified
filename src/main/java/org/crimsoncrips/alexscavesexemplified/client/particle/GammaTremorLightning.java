...
public class GammaTremorLightning extends TextureSheetParticle {
    ...
    protected GammaTremorLightning(ClientLevel level, double x, double y, double z, int tremorzillaId, SpriteSet sprites) {
        ...
        this.yd = 0;
        this.zd = 0;
        this.quadSize *= 10F + random.nextFloat() * 10F;
        this.lifetime = 2;
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            GammaTremorLightning particle = new GammaTremorLightning(worldIn, x, y, z, (int) xSpeed, spriteSet);
            return particle;
        }
    }
