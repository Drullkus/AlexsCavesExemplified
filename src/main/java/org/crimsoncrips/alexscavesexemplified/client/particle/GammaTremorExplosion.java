...
public class GammaTremorExplosion extends TextureSheetParticle {
    ...
    private float fadeG;
    private float fadeB;
    protected GammaTremorExplosion(ClientLevel world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, SpriteSet sprites, boolean shortLifespan, int color1) {
    ...
    public static class TremorzillaFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            GammaTremorExplosion particle = new GammaTremorExplosion(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet, true, 0X03dffc);
