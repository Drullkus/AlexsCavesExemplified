...
public class ACEGammaTremorLightning extends TextureSheetParticle {
    ...
    protected ACEGammaTremorLightning(ClientLevel level, double x, double y, double z, int tremorzillaId, SpriteSet sprites) {
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ACEGammaTremorLightning particle = new ACEGammaTremorLightning(worldIn, x, y, z, (int) xSpeed, spriteSet);
            return particle;
        }
    }
